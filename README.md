...
**🎯 [Live Playground](https://zonedsl.dev)** · **📖 [Docs](https://zonedsl.dev)** · **🤖 [AI Skill](./packages/skill/SKILL.md)**
...
- **80+ 组件** · 5 层（primitive / structure / interactive / chart / preset）
...
| `@zonedsl/wechat` | 微信小程序运行时（zone-node + towxml） | 🚧 coming soon |
...
或直接玩 **[在线 Playground](https://zonedsl.dev)** —— 12 主题实时切、流式播放、60+ 组件全览。
