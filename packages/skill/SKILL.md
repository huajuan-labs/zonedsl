...
| "讲讲梅雨季形成原理和历史" | 科普 + 多小节 |
| "示例艺人甲这一周去了哪些活动" | 多城行程 + 时间线 |
| "示例艺人乙这两天有哪些名场面" | 复盘 + 多个场景 |
| "帮我拆解示例艺人丙原名风波" | 解读 + 事件时间线 |
...
- **中等长度问题**（如"介绍一下示例综艺"）—— 判断你打算写多长：< 400 字用 markdown，≥ 400 字且有多小节用 zonedsl
